...
} from '../../screens/MarktplaceKitaScreens'
import {
  ProfileKitaEditScreen,
  ProfileKitaScreen
} from '../../screens/ProfileKitaScreens'
...
function AngeboteNav () {
  return (
    <KitaNav.Navigator screenOptions={{ headerShown: false }}>
      <KitaNav.Screen
        name='SearchAngeboteScreen'
        component={SearchAngeboteScreen}
      />
      <KitaNav.Screen
        name='ShowAngeboteScreen'
        component={ShowAngeboteScreen}
      />
      <KitaNav.Screen
        name='UebersichtKitaAnfragenAngebote'
        component={UebersichtKitaAnfragenAngebote}
      />
      <KitaNav.Screen
        name='UebersichtKitaKooperationen'
        component={UebersichtKitaKooperationen}
      />
    </KitaNav.Navigator>
  )
}
...
function ProfilKitaNav () {
  return (
    <KitaProfilNav.Navigator screenOptions={{ headerShown: false }}>
      <KitaProfilNav.Screen
        name='ProfileKitaScreen'
        component={ProfileKitaScreen}
      />
      <KitaProfilNav.Screen
        name='ProfileKitaEditScreen'
        component={ProfileKitaEditScreen}
      />
      <KitaProfilNav.Screen
        name='UebersichtKitaAnfragenAngebote'
        component={UebersichtKitaAnfragenAngebote}
