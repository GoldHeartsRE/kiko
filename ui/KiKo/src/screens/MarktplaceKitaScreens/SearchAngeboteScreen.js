          ...
          <View style={styles.modalContent}>
            ...
            <View style={{ flex: 1, alignItems: 'center' }}>
              <TextInput
                ...
                returnKeyType="next"
                autoCapitalize="none"
                onChangeText={(text) => setFilterOption(prevState => ({ ...prevState, titel: text }))}
            ...
            <View style={{ flex: 1, alignItems: 'center', flexDirection: 'row' }}>
              ...
              <View style={{ flex: 0, alignItems: 'center' }}>
                <TextInput
                  ...
                  returnKeyType="next"
                  autoCapitalize="none"
                  onChangeText={(text) => setFilterOption(prevState => ({ ...prevState, alterVon: text }))}
              ...
              <View style={{ flex: 0, alignItems: 'center' }}>
                <TextInput
                  ...
                  returnKeyType="next"
                  autoCapitalize="none"
                  onChangeText={(text) => setFilterOption(prevState => ({ ...prevState, alterBis: text }))}
            ...
            <View style={{ flex: 1, alignItems: 'center', flexDirection: 'row' }}>
              ...
              <View style={{ flex: 0, alignItems: 'center' }}>
                <TextInput
                  ...
                  returnKeyType="next"
                  autoCapitalize="none"
                  onChangeText={(text) => setFilterOption(prevState => ({ ...prevState, kinderVon: text }))}
              ...
              <View style={{ flex: 0, alignItems: 'center' }}>
                <TextInput
                  ...
                  returnKeyType="next"
                  autoCapitalize="none"
                  onChangeText={(text) => setFilterOption(prevState => ({ ...prevState, kinderBis: text }))}
            ...
            <View style={{ flex: 1, alignItems: 'center' }}>
              ...
              <SegmentedButtons
                ...
                onValueChange={(value) => setFilterOption(prevState => ({ ...prevState, dauer: value }))}
            ...
            <View style={{ flex: 1, alignItems: 'center' }}>
              ...
              <SegmentedButtons
                ...
                onValueChange={(value) => setFilterOption(prevState => ({ ...prevState, wochentag: value }))}
            ...
            <View style={{ flex: 1, alignItems: 'center' }}>
              ...
              <SegmentedButtons
                ...
                onValueChange={(value) => setFilterOption(prevState => ({ ...prevState, regel: value }))}
                style={{ backgroundColor: 'white' }}
                buttons={[
            ...
            <View style={{ flex: 1, alignItems: 'center' }}>
              <View style={{ flex: 1, alignItems: 'center', width: 110 }}>
                <TextInput
                  ...
                  returnKeyType="next"
                  autoCapitalize="none"
                  onChangeText={(text) => setFilterOption(prevState => ({ ...prevState, kosten: text }))}
            ...
            <View style={{ flex: 1, alignItems: 'center' }}>
              ...
              <SegmentedButtons
                ...
                onValueChange={(value) => setFilterOption(prevState => ({ ...prevState, felder: value }))}
                style={{ backgroundColor: 'white' }}
                buttons={[
