...
public record PartnerProfilDTO(
                ...
                @Pattern(regexp = "(M|W|Divers)", message = ErrorMessages.GESCHLECHT_UNGUELTIG)
                String geschlecht,
                ...
                @Pattern(regexp = "(Student|berufstaetig|Vereinsmitglied)", message = ErrorMessages.TAETIGKEIT_UNGUELTIG)
                String taetigkeit,
