...
import awp.kiko.security.impl.JwtServiceImpl;
...
private SigninRequest signinRequest;
    ...
    void postSignup200() throws Exception {
        ...
        assertEquals("kiko@test.de", jwtServiceImpl.extractUserName(token));
    }
...
private User createUser(int id, String email, String password) {
